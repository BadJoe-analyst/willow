...
3. La app detecta automáticamente la fecha.
""")
...
if fudo_file and klap_file:
    try:
        ...
        if cerradas["Fecha"].dropna().empty:
            st.error("❌ No se detectó fecha válida en ventas cerradas."); st.stop()
        ...
        # Sumar por categoría en cerradas
        ...
        # Totales de conciliación (solo cerradas)
